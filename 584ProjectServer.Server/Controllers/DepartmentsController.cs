...
namespace _584ProjectServer.Server.Controllers
{
    ...
    public class DepartmentsController : ControllerBase
    {
        ...
        public DepartmentsController(Project584DbContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [Route("IsDupeDepartment")]
        [Authorize]
        public bool IsDupeDepartment(Department department)
        {
            return _context.Departments.AsNoTracking().Any(
                e => e.Name == department.Name
                && e.DeptCode == department.DeptCode
                && e.Id != department.Id
            );
        }
